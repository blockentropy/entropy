...
import (
	...
	"github.com/blockentropy/entropy/docs"
)
...
func New(
	...
	*/
	...
	app.EntropyKeeper = *entropymodulekeeper.NewKeeper(
		appCodec,
		keys[entropymoduletypes.StoreKey],
		keys[entropymoduletypes.MemStoreKey],
		app.GetSubspace(entropymoduletypes.ModuleName),
	)
